...
**Interface** กำหนดว่า Class ที่จะมาทำงานแทน **ต้องมี method อะไรบ้าง** แต่ไม่บอกว่าต้องทำ _ยังไง_ ดูตัวอย่างจริง ([IUserRepository.ts](../src/modules/user/repositories/IUserRepository.ts)):
...
**ปัญหาไก่กับไข่:** ถ้า _"เฉพาะ Admin สร้าง User ได้"_ แล้วใครสร้าง Admin คนแรก? 🤔
...
> 🎯 Seed = สร้างข้อมูลเริ่มต้น _ก่อน_ เปิดระบบ | ใช้ `ON CONFLICT DO NOTHING` เพื่อรันซ้ำได้
...
ปัญหาคลาสสิก: _"ในเครื่องฉันรันได้นะ!"_ 🤷 แต่เครื่องเพื่อนพัง — เพราะ version ต่างกัน, ขาด dependency
